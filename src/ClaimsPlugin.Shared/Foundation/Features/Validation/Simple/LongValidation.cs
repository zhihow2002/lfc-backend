...
public static class LongValidation
{
    ...
    public static bool IsNotNull(
        [NotNullWhen(true)] this long? value,
    ...
    public static bool IsNull(
        [NotNullWhen(false)] this long? value,
        [NotNullWhen(true)] out string? validationMessage,
        [CallerArgumentExpression("value")] string? parameterName = default
    )
    {
    ...
    public static bool IsEqualTo(this long value, long compare)
    {
    ...
    public static bool IsNotEqualTo(this long value, long compare)
    {
        return value != compare;
    }
    ...
    public static bool IsGreaterThan(this long value, long min)
    {
        return value > min;
    }
    ...
    public static bool IsGreaterThanOrEqualTo(this long value, long min)
    {
        return value >= min;
    }
    ...
    public static bool IsLessThan(this long value, long max)
    {
        return value < max;
    }
    ...
    public static bool IsLessThanOrEqualTo(this long value, long max)
    {
        return value <= max;
    }
    ...
    public static bool IsNotBetween(this long value, long min, long max)
    {
        return value < min || value > max;
    }
    ...
    public static bool AnyNull(params long?[] values)
    {
        return values.IsNull() || values.Any(value => value.IsNull());
    }

    public static bool AnyNotNull(params long?[] values)
    {
        return values.IsNotNull() || values.Any(value => value.IsNotNull());
    }

    public static bool AllNull(params long?[] values)
    {
        return values.IsNull() || values.All(value => value.IsNull());
    }

    public static bool AllNotNull(params long?[] values)
    {
