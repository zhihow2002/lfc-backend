...
public class BankDetail : BaseValueObject
{
    ...
    )
    {
        ...
        if (
            bankAccountNumber.IsNullOrWhiteSpace(
                out string? bankAccountNumberNullOrWhiteSpaceErrorMessage
            )
        )
        {
        ...
        if (
            bankAccountNumber.HasLengthMoreThan(50, out string? bankAccountNumberLengthErrorMessage)
        )
        {
        ...
        if (
            bankBranchCode.IsNullOrWhiteSpace(
                out string? bankBranchCodeNullOrWhiteSpaceErrorMessage
            )
        )
        {
